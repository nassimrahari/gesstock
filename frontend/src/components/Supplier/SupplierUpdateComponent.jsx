...
import { updateSupplier, fetchSuppliersItem } from '../../services/supplierService';




import { usePopup } from './SupplierPopupContext'; // Importer le context
...
const [fieldPhone_number, setFieldPhone_number] = useState('');
    ...
    useEffect(() => {
        const fetchItem = async () => {
            const result = await fetchSuppliersItem(itemEditId);
            setId(result.id);
...
export default SupplierUpdateComponent;
