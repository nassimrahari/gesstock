...
import { fetchCategorys, deleteCategory } from '../../services/categoryService';
import { usePopup } from './CategoryPopupContext'; // Importer le contexte
...
import CategoryListPdfComponent from './CategoryListPdfComponent';
...
const CategoryList = () => {
    ...
    return (
        <div>
            <CategoryListPdfComponent categorys={items} />
            <Input 
                type="text" 
                placeholder="Search..."
                value={searchTerm}
