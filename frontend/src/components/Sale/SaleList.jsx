...
import { usePopup } from './SalePopupContext'; // Importer le contexte
...
import SaleListPdfComponent from './SaleListPdfComponent';
...
const SaleList = () => {
    ...
    return (
        <div>
            <SaleListPdfComponent sales={items} />
            <Input 
                type="text" 
                placeholder="Search..."
                value={searchTerm}
                    ...
                    {currentItems.map(item => (
                        <TableRow key={item.id} className="border-b dark:text-white">
                            ...
                            <TableCell>{item.sale_date}</TableCell>
                                ...
                                <TableCell>{item.client.repr}</TableCell>
