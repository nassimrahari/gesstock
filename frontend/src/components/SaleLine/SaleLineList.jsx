...
import { fetchSaleLines, deleteSaleLine } from '../../services/salelineService';
import { usePopup } from './SaleLinePopupContext'; // Importer le contexte
...
import SaleLineListPdfComponent from './SaleLineListPdfComponent';
...
const SaleLineList = () => {
    ...
    useEffect(() => {
        const fetchItems = async () => {
            const result = await fetchSaleLines();
    ...
    return (
        <div>
            <SaleLineListPdfComponent salelines={items} />
            <Input 
                type="text" 
                placeholder="Search..."
                value={searchTerm}
                    ...
                    {currentItems.map(item => (
                        <TableRow key={item.id} className="border-b dark:text-white">
                            <TableCell>{item.id}</TableCell>
                                ...
                                <TableCell>{item.sale.repr}</TableCell>
