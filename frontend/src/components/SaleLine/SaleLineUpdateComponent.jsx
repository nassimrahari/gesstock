...
import { updateSaleLine, fetchSaleLinesItem } from '../../services/salelineService';
...
const [fieldPrice, setFieldPrice] = useState('');
    ...
    useEffect(() => {
        const fetchItem = async () => {
            const result = await fetchSaleLinesItem(itemEditId);
            setId(result.id);
...
setFieldPrice(result.price);
    ...
    return (
        ...
        <Dialog open={openUpdate} onOpenChange={setOpenUpdate}>
            ...
            >
                <DialogHeader>
                    <DialogTitle>Edit SaleLine</DialogTitle>
                </DialogHeader>
...
export default SaleLineUpdateComponent;
