...
import { usePopup } from './PurchasePopupContext'; // Importer le contexte
...
import PurchaseListPdfComponent from './PurchaseListPdfComponent';
...
const PurchaseList = () => {
    ...
    return (
        <div>
            <PurchaseListPdfComponent purchases={items} />
            <Input 
                type="text" 
                placeholder="Search..."
                value={searchTerm}
                    ...
                    {currentItems.map(item => (
                        <TableRow key={item.id} className="border-b dark:text-white">
                            ...
                            <TableCell>{item.purchase_date}</TableCell>
                                ...
                                <TableCell>{item.supplier.repr}</TableCell>
