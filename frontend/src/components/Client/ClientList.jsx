...
import { usePopup } from './ClientPopupContext'; // Importer le contexte
...
import ClientListPdfComponent from './ClientListPdfComponent';
...
const ClientList = () => {
    ...
    return (
        <div>
            <ClientListPdfComponent clients={items} />
            <Input 
                type="text" 
                placeholder="Search..."
                value={searchTerm}
